...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    profile_picture = models.ImageField(
        _("Profile Picture"),
        upload_to='profile_pics/',  # Directory where profile pictures will be stored
        default='default.jpg',      # Optional: default profile picture
        blank=True,                 # Optional: allow users to have no profile picture
        null=True,
    )
    # newly added username
